...
# Listing 9.10
"""
Обобщенное представление выполнит запрос к базе дан­ных, получит все записи заданной модели (вооk), 
а затем заполнит соответствую­щий шаблон для выдачи списка книг ( файл book_list.html)
"""
from django.views import generic    
class BookListView(generic.ListView):
    model = Book
    # Listing 9.16
    # Как только в базе данных появится более трех записей, представление начнет фор­мировать постраничный вывод данных (страницы будут передаваться шаблону).
    paginate_by = 3
